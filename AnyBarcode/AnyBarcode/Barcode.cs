...
namespace AnyBarcode
{
    ...
    public partial class Barcode : IDisposable
    {
        ...
        /// </summary>
        public Font LabelFont { get; set; } = new Font(_fontFamily.Value, 10 * DotsPerPointAt96Dpi, FontStyle.Bold);
        ...
        {
            if (EncodedImageBytes is null) throw new ArgumentNullException(nameof(EncodedImageBytes), "You must generate a barcode before getting data.");
